...
float Pi = 3.14159265358979323846264338327952,y_dist=0.0;
bool flag=false,slideFlag=false,gameoverflag=true,animateFlag=false;
int basketBelow=1,basketAbove=3,life=initiallife,points=0,animateCount=0,ellipseSize=2;
struct star {
    float x, y;
    float vx, vy;
} ;
